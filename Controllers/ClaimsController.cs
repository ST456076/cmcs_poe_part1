...
namespace cmcs_poe_part1.Controllers
{
    public class ClaimsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ClaimType,Description,Amount,DateSubmitted,Status")] Claim claim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClaimType,Description,Amount,DateSubmitted,Status")] Claim claim)
        {
            if (id != claim.Id)
            {
                return NotFound();
